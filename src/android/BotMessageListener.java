...
import com.liteputer.cordova.plugin.BotConstants;
...
public class BotMessageListener implements IBotMessageListener {
     ...
     * @param customData 自定义数据，结构化数据。参考 <a herf=
     *                   "http://icode.baidu.com/repos/baidu/duer/open-platform-api-doc/blob/master:dueros-conversational-service/device-interface/bot-app-sdk-private.md">BotSDK协议文档</a>
     */
    @Override
     ...
     * 例如APP新增自定义交互样例{@code <"试一试"，url>},用户query"试一试" 之后DuerOS会通过此接口下发 上面定义的url
    ...
    public void onRegisterSucceed() {
        ...
        Toast.makeText(ContextUtil.getContext(), "注册成功", Toast.LENGTH_LONG).show();
